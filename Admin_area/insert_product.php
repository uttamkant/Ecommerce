<form action="" method="post" class="mb-2">
    <div class="input-group w-90 mb-2">
        ...
        fa-receipt"></i></span>
        <input type="text" class="form-control"  name="cat_title" placeholder="Insert Prodcut"
        aria-lable="Product" aria-describedby="basic-addon1">
    </div>
    <div class="input-group w-10 mb-2 m-auto">
        ...
        <button class="bg-info p-2 my-3 border-0">Insert Product</button>
    </div>
</form>